...
my_dash_layout = html.Div([
    ...
    html.H4("This is an interactive dashboard based on Plotly Dash, enabling the analysis of penguin data - filtering by species, gender and parameter.", style={'textAlign': 'center'}),
    ...
    html.Div([
        ...
        html.Div([
            ...
            dcc.Dropdown(
                ...
                value='body_mass_g',
                style={'backgroundColor': 'rgba(0,0,0,0.8)', 'color': 'red'}
            ),
        ], style={'width': '30%', 'display': 'inline-block', 'padding': '10px'}),
    ], style={'textAlign': 'center', 'padding': '20px', 'display': 'flex', 'justifyContent': 'space-around'}),
    ...
    html.Div([
        ...
        html.Table(id='data-table', style={'width': '100%', 'overflowX': 'scroll'})
    ], style={'padding': '20px'}),
